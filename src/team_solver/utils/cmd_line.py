...
def create_solvers(ctor, name_prefix, solvers_args):
...
def create_solvers_from_args(args):
    ...
    stp_wrappers = create_solvers(STPParser, "STP", args.stp_solvers)
    z3_wrappers = create_solvers(Z3Parser, "Z3", args.z3_solvers)
    boolector_wrappers = create_solvers(BoolectorParser, "Boolector", args.boolector_solvers)
